...
const Home = () => {
      ...
      <div className="bg-white h-150 mt-60 pt-10">
        <div className="container mx-auto p-4">
          ...
          <div className="grid grid-cols-4 gap-4 pt-10">
            <div className="flex flex-col items-center hover:text-pink-400">
 ...
 <div className="border border-gray-200 rounded-xl p-3 bg-white hover:shadow hover:border-pink-400">
    ...
    <div className="flex justify-center mt-16 ">
      ...
      <button className="bg-[#3A5134] hover:bg-pink-500  text-white px-6 py-3 rounded-lg flex items-center gap-2 transition">
