  ...
  const faqs = [
    {
      ...
      answer: (
        <>
          <p>
            We deliver beauty products across Nepal at the most affordable fees,
            with rates varying by location.
          </p>
          ...
          <p className="mt-3">
            The order generally gets dispatched in 1–2 working days and shipment
            time is around 1–2 working days for inside valley. Orders from
            outside valley may take 2–4 days.
          </p>
        </>
      ),
    },

    {
      ...
      answer: (
        <p>We accept Cash on Delivery, eSewa, Khalti, and bank transfer.</p>
      ),
    },

    {
      ...
      answer: (
        <>
          ...
          <p className="mt-3">
            Or, login to your account and under My Account, there is a My Order
            option from where you can track the current status of your
            respective orders.
          </p>
        </>
      ),
      ...
      answer: (
        <>
          <p>
            ...
            until the order is being processed, and cannot be canceled once the
            order is confirmed.
          </p>
    ...
    {
      question:
        "How do I add, remove or minimize products to my existing order?",
      answer: (
        <p>
          Once you place an order, other products cannot be added or minimized.
          To add a new product, you need to place a new order. If you wish to
          get all of your orders together, please write remarks mentioning the
          previous order number on your new order.
        </p>
      ),
    },

    {
      ...
      answer: <p>There are no separate cancellation charges.</p>,
    },

    {
      ...
      answer: (
        <p>
          Kindly give us a call at <strong>+977 9802524642</strong> and our team
                  ...
                  >
                    ...
                    <span
                      className={`text-xl flex-shrink-0 transition-transform duration-300 ${
                        isOpen ? "rotate-180 text-pink-600" : "text-gray-600"
                      }`}
                    >
                      ▼
                    </span>
