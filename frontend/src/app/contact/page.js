    ...
    <div className="bg-white text-gray-900 min-h-screen ">
      {/* HERO */}
        ...
        <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] bg-[#fdf5f7] ">
          <img src="/images/contacts.png" className="block w-full h-auto object-cover mt-10"></img>
        </div>
      ...
      <section className="w-full mx-auto px-8 py-16 bg-[#f5a5c1]">
        ...
        <div className="text-center">
          <h2 className="text-4xl font-extrabold text-[#3A5134]">Quick Answers</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6">
            ...
            <p className="text-gray-600 mt-2 leading-relaxed text-center">
              If the product is defective or damaged, you can exchange it within
              7 days.
            </p>
          </div>
        </div>
